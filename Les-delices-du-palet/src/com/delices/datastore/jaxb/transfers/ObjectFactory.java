 ...
 * generated in the com.delices.datastore.jaxb.transfers package. 
...
public class ObjectFactory {
    ...
    private final static QName _League_QNAME = new QName("http://feed.elasticstats.com/schema/hockey/transfers-v2.0.xsd", "league");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.delices.datastore.jaxb.transfers
     * 
     */
    ...
    /**
     * Create an instance of {@link TransfersType }
     * 
     */
    public TransfersType createTransfersType() {
        return new TransfersType();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://feed.elasticstats.com/schema/hockey/transfers-v2.0.xsd", name = "league")
